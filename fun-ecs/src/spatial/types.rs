...
pub enum EcsSpatialValidationError {
    ...
    InvalidProceduralSyncManifest,
    InvalidProceduralRecipe,
    UnsupportedProceduralVersion,
    InvalidProceduralDigestProbe,
    ProceduralPageDigestMismatch,
...
impl EcsSpatialValidationError {
    ...
    pub const fn label(self) -> &'static str {
        match self {
            ...
            Self::InvalidProceduralSyncManifest => "invalid_procedural_sync_manifest",
            Self::InvalidProceduralRecipe => "invalid_procedural_recipe",
            Self::UnsupportedProceduralVersion => "unsupported_procedural_version",
            Self::InvalidProceduralDigestProbe => "invalid_procedural_digest_probe",
            Self::ProceduralPageDigestMismatch => "procedural_page_digest_mismatch",
