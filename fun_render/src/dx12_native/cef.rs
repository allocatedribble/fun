use crate::{
    FUN_RENDER_CEF_UI_STAGE, FUN_RENDER_CEF_UI_Z_INDEX, FUN_RENDER_DEBUG_OVERLAY_STAGE,
    FUN_RENDER_HUD_UI_STAGE, FunRenderCompositionStage,
};

pub const DX12_CEF_TRANSPORT_SCHEMA_VERSION: u16 = 1;
pub const DX12_CEF_SHARED_TEXTURE_RING_DEPTH_DEFAULT: u8 = 3;

#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum Dx12CefTransportPath {
...
pub struct Dx12CefTransportPolicy {
    pub schema_version: u16,
    pub preferred_path: Dx12CefTransportPath,
    ...
    pub cef_uploads_count_as_world_uploads: bool,
    pub composition_stage: FunRenderCompositionStage,
    pub composition_z_index: i32,
}

impl Dx12CefTransportPolicy {
    pub const DEFAULT: Self = Self {
        schema_version: DX12_CEF_TRANSPORT_SCHEMA_VERSION,
        preferred_path: Dx12CefTransportPath::D3d11On12SharedTextureRing,
        shared_texture_ring_depth: DX12_CEF_SHARED_TEXTURE_RING_DEPTH_DEFAULT,
        ...
        cef_uploads_count_as_world_uploads: false,
        composition_stage: FUN_RENDER_CEF_UI_STAGE,
        composition_z_index: FUN_RENDER_CEF_UI_Z_INDEX,
    };
    ...
    #[must_use]
    pub const fn keeps_cef_after_world_postprocess(self) -> bool {
        self.composition_stage.order_key() > FunRenderCompositionStage::PostProcessing.order_key()
            ...
            && self.composition_z_index >= FUN_RENDER_CEF_UI_Z_INDEX
    }

    #[must_use]
    pub const fn keeps_cef_out_of_temporal_reconstruction(self) -> bool {
    ...
    #[must_use]
    pub const fn keeps_cef_out_of_world_upload_accounting(self) -> bool {
        !self.cef_uploads_count_as_world_uploads
    }
    ...
    pub const fn is_nonblocking_gpu_transport(self) -> bool {
        matches!(
            self.preferred_path,
            Dx12CefTransportPath::D3d11On12SharedTextureRing
                | Dx12CefTransportPath::SharedTextureRing
        ) && !self.normal_frame_blocking_wait_allowed
    }
}

impl Default for Dx12CefTransportPolicy {
    fn default() -> Self {
        Self::DEFAULT
    }
}
...
#[must_use]
pub const fn dx12_cef_transport_policy() -> Dx12CefTransportPolicy {
    Dx12CefTransportPolicy::DEFAULT
}
...
mod tests {
    ...
    #[test]
    fn dx12_cef_prefers_shared_texture_ring_without_blocking_wait() {
    ...
    #[test]
    fn dx12_cef_cpu_fallback_is_dirty_rect_and_cef_accounted() {
        let policy = dx12_cef_transport_policy();
    ...
    #[test]
    fn dx12_cef_composes_after_postprocess_and_before_debug() {
        let policy = dx12_cef_transport_policy();

        assert!(policy.keeps_cef_after_world_postprocess());
