...
| UI render buffers | `bevy_ui_render/src/{lib,gradient,box_shadow,ui_material_pipeline,ui_texture_slice_pipeline}.rs` | Per-frame Bevy UI vertex/index buffers; should be near-zero for the NATIVE_UI/Svelte UI path except diagnostics/FPS. |
