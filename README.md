...
It starts by reusing Bevy's confirmed `bsn!`/`bsn_list!` surface through
FUN-owned `fun!`/`fun_list!` aliases, then becomes the owner for deterministic
scene manifests, server/editor scene authority, streaming declarations,
